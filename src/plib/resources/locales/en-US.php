...
$messages = array(
    ...
    'getAuthNoRoot' => 'Please, make sure to grant the "route53:*" and "route53domains:*" permissions to the account (<a href="%%learnMoreUrl%%">learn more</a>).',
    ...
    'awsDescriptionWindow' => 'To manage Route53, you need a restricted IAM user account to authenticate with Amazon.',
    'awsDescriptionWindowRoot' =>' If you provide root account credentials, Plesk will create a restricted IAM user account for you.',
    'awsKeyType' => 'Key type',
